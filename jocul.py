...
empty_box = "[_]"
list_incercari = []
def push_x(tabla,mark_x, useri_dict):
    """Jocul pt X"""
    tabel_nr = ["1", "2", "3"]
    tabel_lit = ["a", "b", "c"]
    game1 = True
...
def push_o(tabla, mark_o, useri_dict):
    """Jocul pt 0"""
    tabel_nr = ["1", "2", "3"]
    tabel_lit = ["a", "b", "c"]
    game1 = True
...
def joc(tabla,mark_x,mark_o, prim_x, prim_o, empty_box, useri_dict):
...
joc(tabla,mark_x,mark_o, prim_x, prim_o, empty_box, useri_dict)
os.system('cls')
print(f"3 > {rand3}\n2 > {rand2}\n1 > {rand1}\n       ^      ^      ^\n       A      B      C")